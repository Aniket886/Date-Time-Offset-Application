"""
Django settings for PWA Date-Time Offset Application.
"""
import os
...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-pwa-version-change-in-production")
...
STATIC_URL = "static/"
STATICFILES_DIRS = [BASE_DIR / "offset_app/static"]
